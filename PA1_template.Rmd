...
```
Average total number of steps taken per day is `r avg_steps_per_day`.
...
The most steps (on average ```r max_steps_per_interval$avg_steps```) were taken at interval ```r max_steps_per_interval$interval```
